...
namespace boost { namespace threadpool
{
  ...
  */ 
  ...
  //typedef boost::function<void(void*,void*)> task_jay;
  
  typedef  struct thdpool_thdinfo_t* task_jay;
  typedef struct thdpool_thdinfo_t{
    
    boost::function<void(void*,void*)>  func;
    void*    argc;
